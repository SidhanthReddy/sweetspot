...
import { Eye, EyeOff, Mail, Lock, User, Phone, MapPin, Map } from 'lucide-react';
...
const LoginPage = () => {
  ...
  const renderLoginForm = () => (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-red-400 text-white py-3 rounded-lg hover:bg-red-500 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
      >
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-center space-x-2 mb-6">
        <div className="flex items-center">
          <div className="w-8 h-8 bg-red-400 text-white rounded-full flex items-center justify-center text-sm font-medium">1</div>
  ...
  const renderSignupStep2 = () => (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-center space-x-2 mb-6">
        ...
        <div className="flex items-center">
          <div className="w-8 h-8 bg-red-400 text-white rounded-full flex items-center justify-center text-sm font-medium">2</div>
      ...
      <h3 className="text-lg font-semibold text-gray-800 text-center mb-4">Personal Information</h3>
  ...
  const renderSignupStep3 = () => (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-center space-x-2 mb-6">
        ...
        <div className="w-8 h-px bg-green-500"></div>
        <div className="flex items-center">
          <div className="w-8 h-8 bg-red-400 text-white rounded-full flex items-center justify-center text-sm font-medium">3</div>
          <div className="text-xs text-red-400 mt-1 ml-1">Address</div>
        </div>
      </div>

      <h3 className="text-lg font-semibold text-gray-800 text-center mb-4">Delivery Address</h3>
      <p className="text-sm text-gray-600 text-center mb-4">Click on the map to set your location</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-red-100 flex items-center justify-center py-12 px-4">
      <div className={`w-full bg-white rounded-xl shadow-2xl p-8 ${isLogin ? 'max-w-md' : 'max-w-2xl'}`}>
        {/* Header */}
        ...
        {isLogin ? renderLoginForm() : 
         currentStep === 1 ? renderSignupStep1() :
         currentStep === 2 ? renderSignupStep2() :
         renderSignupStep3()}
