      ...
      <div className="block md:hidden">
        ...
        <div className="text-center mb-8 sm:mb-10">
          <h1 className="font-parastoo text-xl sm:text-2xl text-[rgba(79,79,79,0.66)] leading-tight mb-4 sm:mb-5">
            ...
            <span className="highlighted-text text-2xl sm:text-3xl block mt-2 sm:mt-3">Sweet Spot</span>
          </h1>
        ...
        <div className="flex justify-center mb-20 mt-16">
          <div className="relative">
            {/* Progress Bar */}
            <div className="relative w-2 sm:w-2.5 bg-white rounded-full shadow-lg mx-auto" style={{ height: '400px' }}>
              {/* Progress Fill */}
              <div 
                ...
                >
                  <div className="flex items-start space-x-2 sm:space-x-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="font-semibold text-black text-sm sm:text-base leading-tight">{step.title}</h3>
                      <p className="text-black text-xs sm:text-sm opacity-75 mt-1 sm:mt-1.5 leading-relaxed">{step.description}</p>
                    </div>
                  </div>
        ...
        <div className="text-center px-4 sm:px-6">
          <h2 className="font-parastoo text-lg sm:text-xl text-[rgba(79,79,79,0.66)] leading-tight">
            Unwrap the <span className="Love-highlighted-text">dreams</span> we've turned into{' '}
      ...
      <div className="hidden md:block lg:hidden">
        ...
        <div className="text-center mb-12">
          <h1 className="font-parastoo text-4xl text-[rgba(79,79,79,0.66)] leading-tight mb-6">
            Turn Your Dream Cake into Reality at{' '}
            <span className="highlighted-text text-5xl block mt-4">Sweet Spot</span>
          </h1>
        ...
        <div className="flex justify-center mb-20 mt-16">
          <div className="relative">
            ...
            <div className="relative w-4 bg-white rounded-full shadow-lg" style={{ height: `${steps.length * 100}px` }}>
              {/* Progress Fill */}
              <div 
                className="absolute top-0 left-0 w-full bg-gradient-to-br from-[rgba(224,99,99,1)] to-[rgba(215,135,157,1)] rounded-full transition-all duration-300 ease-out"
                style={{ height: `${progress}%` }}
      ...
      <div className="hidden lg:flex lg:mt-12 xl:mt-20 lg:ml-10 xl:ml-20">
          ...
          <div className="flex items-center justify-center ">
            <div>
              <h1 className="font-parastoo text-4xl xl:text-5xl text-[rgba(79,79,79,0.66)] leading-tight mb-3 xl:mb-4">
                Turn Your Dream Cake into Reality at <span className="highlighted-text text-5xl xl:text-7xl">Sweet Spot</span>
              </h1>
        ...
        <div className="flex-1 flex items-center justify-center p-3 xl:p-4">
          <div className="relative">
            ...
            <div className="relative w-3 xl:w-4 bg-white rounded-full shadow-lg" style={{ height: `${steps.length * 100}px` }}>
              {/* Progress Fill */}
              <div 
                className="absolute top-0 left-0 w-full bg-gradient-to-br from-[rgba(224,99,99,1)] to-[rgba(215,135,157,1)] rounded-full transition-all duration-300 ease-out"
                style={{ height: `${progress}%` }}
              ...
              return (
                ...
                >
                  <div className="flex items-center space-x-2 xl:space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-black text-base xl:text-lg">{step.title}</h3>
                      <p className="text-black text-sm xl:text-base opacity-75">{step.description}</p>
                    </div>
                  </div>
