    ...
    <>
      <form className="space-y-6 font-parastoo" autoComplete="off" onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-[rgba(79,79,79,0.7)] text-sm mb-1">Cardholder Name</label>
            <input
              type="text"
      ...
      <ValidationModal
        ...
        message="Please fill out all required payment fields: card number, expiry date, CVC, and cardholder name."
        actionText="Got it"
      />
    </>
  );
